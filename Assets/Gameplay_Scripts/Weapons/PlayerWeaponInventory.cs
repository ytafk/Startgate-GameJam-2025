...
public class PlayerWeaponInventory : MonoBehaviour
{
    ...
    [Header("UI")]
    // Burası boş kalmış, önemli değil WeaponUIManager singleton üzerinden çalışacak.
    ...
    public UIManager messageUI; // Eski text tabanlı UI referansın
    ...
    // ---------------------------------------------------------
    // DÜZENLEME YAPILAN FONKSİYON BURASI
    // ---------------------------------------------------------
    void Equip(WeaponBase w)
    {
        ...
        // >>>>>>>>>>>> BURASI EKLENDİ <<<<<<<<<<<<
        // WeaponUIManager sahne de varsa (null değilse), silahın resmini güncelle
